...
import { Link } from "react-router-dom"; // import 'Link' component from react-router-dom to create links

const SearchResult = ({ course }) => { // define a functional component named 'SearchResult' that takes 'course' as prop

    return (
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-300 py-4 gap-4">
            <Link
                to={`/course-detail/${course._id}`} // redirect user to course
