...
const NoChatHistoryPlaceholder = ({ name }) => { // create a functional component named 'NoChatHistoryPlaceholder' to display message when no chat has been done with a user
    // it takes name of the user you haven't messaged anything as a prop
    return (
        <div className="flex flex-col items-center justify-center h-full text-center p-6">
            ...
            <h3 className="text-lg font-medium text-slate-200 mb-3">
                Start your conversation with {name} {/* render user's name you haven't messaged anything */}
            </h3>
