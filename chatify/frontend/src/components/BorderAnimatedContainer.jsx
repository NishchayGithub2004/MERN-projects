function BorderAnimatedContainer({ children }) { // create a functional component named 'BorderAnimatedContainer' that takes 'children' JSX as a prop
    return (
