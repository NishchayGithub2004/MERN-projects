import { MessageCircleIcon } from "lucide-react"; // import message circle icon to visually represent empty chat state

const NoChatHistoryPlaceholder = ({ name }) => { // define a functional component to display a placeholder when no chat history exists for a user
    return (
        <div className="flex flex-col items-center justify-center h-full text-center p-6">
            ...
            <h3 className="text-lg font-medium text-slate-200 mb-3">
                Start your conversation with {name} {/* inject selected user's name dynamically into placeholder message */}
            </h3>
